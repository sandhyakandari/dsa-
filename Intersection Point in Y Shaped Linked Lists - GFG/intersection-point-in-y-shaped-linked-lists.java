...
class Intersect
{
	...
	{
	    /* first approach - use two dummy node find length of both the list then subtract max length -sortlength=n then shift the max length linkedlist n time and start iterating both list if node point same node then this is the
	    intersection point
